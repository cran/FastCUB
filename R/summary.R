...
#' @param pnames A vector of character for names to be assigned to estimated parameters
...
summary.fastCUB <- function(object, correlation=FALSE, pnames=object$parnames,...){
  ...
  print.summary.fastCUB <- function(x,...){
    ...
    StdErr<-object$se #x$errstd
    Wald<-x$wald
    modello<-object$formula



    covpai<-  object$env$covpai  
    covcsi<- object$env$covcsi 

    listanomi<-    rownames(x$results)
    ...
    cat("=======================================================================","\n")
    cat("Elapsed time=",object$time,"seconds","\n")
    cat("=======================================================================","\n")
